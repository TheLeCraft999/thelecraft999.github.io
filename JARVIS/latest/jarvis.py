...
CMDS_DIR = os.path.join(JARVIS_DIR, 'cmds')''')
    ...
    if not os.path.exists(f'{os.path.dirname(os.path.realpath(__file__))}/cmds/__init__.py'):
        ...
        with open(f'{os.path.dirname(os.path.realpath(__file__))}/cmds/__init__.py', 'r') as file:
            file.close()
...
if __name__ == '__main__':
    if os.path.exists(f'{os.path.dirname(os.path.realpath(__file__))}/data') and os.path.exists(f'{os.path.dirname(os.path.realpath(__file__))}/cmds'):
